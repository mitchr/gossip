...
func New(c *Config) (*Server, error) {
	s := &Server{
		...
		supportedCaps: []cap.Cap{cap.AwayNotify, cap.CapNotify, cap.Chghost, cap.EchoMessage, cap.MessageTags, cap.MultiPrefix, cap.SASL, cap.ServerTime, cap.Setname, cap.UserhostInNames},
